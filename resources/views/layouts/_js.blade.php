...
<script src="https://polyfill.io/v3/polyfill.min.js?features=window.scroll"> // erro ao importar</script>
...
<script src="{{ asset('js/google-utils.js') }}"></script>
<script src="{{ asset('js/google-commons.js') }}"></script>
